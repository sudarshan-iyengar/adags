...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.enable_prior_admission = False
        self.prior_admission_calibration_views = 0
        self.prior_admission_calibration_max_side = 192
        self.prior_admission_min_hard_coverage = 0.05
        self.prior_admission_flow_mass_tolerance = 1.05
        self.prior_admission_use_flow_agreement = True
        self.prior_admission_use_static_anchor = True
        self.prior_admission_use_hard_floor = True
        self.prior_admission_r_core = 1
        self.prior_admission_r_ring = 2
        self.prior_admission_r_anchor = 6
        self.prior_admission_gamma_ring = 0.0
        self.prior_admission_T_flow = 0.02
        self.prior_admission_T_anchor = 0.02
        self.prior_admission_tau_min = 0.25
        self.prior_admission_alpha = 0.05
        self.prior_admission_eta_anchor = 1.0
        self.prior_admission_mask_threshold = 0.5
        self.prior_admission_hard_quantile = 0.8
        self.prior_admission_anchor_pool_radius = 2
        self.prior_admission_grid_r_core = "1,2,3"
        self.prior_admission_grid_r_ring = "2,4,6"
        self.prior_admission_grid_r_anchor = "6,10"
        self.prior_admission_grid_gamma_ring = "0.0,0.25"
        self.prior_admission_grid_T_flow = "0.01,0.02,0.04"
        self.prior_admission_grid_T_anchor = "0.01,0.02,0.04"
        self.prior_admission_grid_tau_min = "0.25,0.5"
        self.prior_admission_grid_alpha = "0.0,0.05,0.10"
