...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        if raster_settings.debug:
            ...
            try:
                num_rendered, color, flow, depth, T, radii, geomBuffer, binningBuffer, imgBuffer, covs_com, out_means3D, radii_static, color_4d, color_3d, invdepths = _C.rasterize_gaussians(*args)
            except Exception as ex:
                torch.save(cpu_args, "snapshot_fw.dump")
                print("\nAn error occured in forward. Please forward snapshot_fw.dump for debugging.")
                raise ex
        else:
            num_rendered, num_buckets, color, flow, depth, T, radii, geomBuffer, binningBuffer, imgBuffer, sampleBuffer, covs_com, out_means3D, radii_static, color_4d, color_3d, invdepths = _C.rasterize_gaussians(*args)
        ...
        ctx.save_for_backward(colors_precomp, means3D, out_means3D, scales, rotations, cov3Ds_precomp, radii, sh, 
                                ...
                                geomBuffer, binningBuffer, imgBuffer, sampleBuffer, means3D_static, scales_static, rotations_static, sh_static, opacities_static, radii_static)
        return color, radii, depth, 1-T, flow, covs_com, radii_static, color_4d, color_3d, invdepths

    @staticmethod
    def backward(ctx, grad_out_color, grad_radii, grad_depth, grad_alpha, grad_flow, grad_covs_com, grad_radii_static, color_4d, color_3d, grad_invdepths):
        ...
        (colors_precomp, means3D, out_means3D, scales, rotations, cov3Ds_precomp, radii, sh, 
         flow_2d, opacities, ts, scales_t, rotations_r,
         geomBuffer, binningBuffer, imgBuffer, sampleBuffer, means3D_static, scales_static, rotations_static, sh_static, opacities_static, radii_static) = ctx.saved_tensors
        ...
        if raster_settings.debug:
            ...
            try:
                ...
                grad_rotations, grad_rotations_r, grad_means2D_static, grad_opacities_static, grad_means3D_static, grad_sh_static, grad_scales_static, grad_rotations_static) = _C.rasterize_gaussians_backward(*args)
            except Exception as ex:
...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, means3D_static, means2D_static, opacities_static, shs_static = None, scales_static = None, rotations_static = None, shs = None, colors_precomp = None, flow_2d = None, ts=None,
