...
| R029 train | Matched 6000-to-6400 continuation control | `8ebb53d` | `48935431`, `48935450`, `48935478` | `refine-logs/route0_continue_6400_train_jobs_20260708_152429.tsv`, `configs/n3v/route0_continue_6400_control.yaml` | TRAIN RUNNING | Tests whether R027's tiny gain is just extra training. Same route0 start checkpoints and target iteration, no event support and no motion-aware densification. Early logs show the config launched and per-job CUDA extensions began compiling; no eval/scoring verdict yet. |
| R030 train | Frozen-crop support, Gaussian-only micro-densification | `8ebb53d` | `48935580`, `48935581`, `48935583` | `refine-logs/oracle_crop_support_micro_densify_train_jobs_20260708_153750_manual.tsv`, `configs/n3v/oracle_crop_support_micro_densify_6400.yaml` | TRAIN RUNNING | Diagnostic only; uses frozen R009 crops as support but no GT compositing. Distinguishes support-discovery failure from posthoc Gaussian optimization failure. Duplicate cut jobs from timed-out submissions (`48935560`, `48935682`) are excluded from the valid manifest; `48935560` cancellation returned success and `48935682` was observed cancelled. |
