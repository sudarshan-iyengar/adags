...
| R021 | Candidate-local refinement plumbing | `86c1afc21da3948600b9b98f6e0c500c01f78dfc` | pending | `configs/n3v/event_candidate_local_refine_6200.yaml`, `scripts/submit_event_candidate_refine.sh` | READY | Adds non-oracle candidate-mask intersection in `MotionPriorCache` plus train/eval Slurm helper for route0 checkpoint resumes; no trained output yet. |
